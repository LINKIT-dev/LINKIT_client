                    ...
                    children: [
                      TextButton(
                        ...
                        style: TextButton.styleFrom(
                          padding: EdgeInsets.symmetric(
                              horizontal: 8, vertical: 4), // 패딩을 줄입니다.
                          backgroundColor: Colors.lightGreen, // 배경 색상 설정
                          primary: Colors.black87, // 텍스트 색상 설정
                      ...
                      TextButton(
                        ...
                        style: TextButton.styleFrom(
                          padding: EdgeInsets.symmetric(
                              horizontal: 8, vertical: 4), // 패딩을 줄입니다.
                          backgroundColor: Colors.blueAccent, // 배경 색상 설정
                          primary: Colors.black87, // 텍스트 색상 설정
                          shape: RoundedRectangleBorder(
                            borderRadius:
                                BorderRadius.circular(20), // 모서리의 둥근 정도를 설정
                      ...
                      TextButton(
                        ...
                        style: TextButton.styleFrom(
                          padding: EdgeInsets.symmetric(
                              horizontal: 8, vertical: 4), // 패딩을 줄입니다.
                          backgroundColor: Colors.orange, // 배경 색상 설정
                          primary: Colors.black87, // 텍스트 색상 설정
                          shape: RoundedRectangleBorder(
                            borderRadius:
                                BorderRadius.circular(20), // 모서리의 둥근 정도를 설정
